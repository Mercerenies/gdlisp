...
(sys/declare superfunction sqrt (a) public)
(sys/declare superfunction fmod (a b) public)
(sys/declare superfunction fposmod (a b) public)
(sys/declare superfunction posmod (a b) public)
(sys/declare superfunction sign (a) public)
(sys/declare superfunction ord (a) public)
(sys/declare superfunction hash (a) public)
(sys/declare superfunction get-stack () public)
(sys/declare superfunction is-nan (a) public)
(sys/declare superfunction is-inf (a) public)
(sys/declare superfunction is-equal-approx (a b) public)
(sys/declare superfunction is-zero-approx (a) public)
(sys/declare superfunction inverse-lerp (a b c) public)
(sys/declare superfunction lerp (a b c) public)
(sys/declare superfunction lerp-angle (a b c) public)
(sys/declare superfunction pow (a b) public)
(sys/declare superfunction stepify (a b) public)
(sys/declare superfunction step-decimals (a) public)
(sys/declare superfunction seed (a) public)
(sys/declare superfunction rand-seed (a) public)
(sys/declare superfunction deg2rad (a) public)
(sys/declare superfunction rad2deg (a) public)
(sys/declare superfunction db2linear (a) public)
(sys/declare superfunction linear2db (a) public)
(sys/declare superfunction is-instance-valid (a) public)
(sys/declare superfunction log (a) public)
(sys/declare superfunction wrapf (a b c) public)
(sys/declare superfunction wrapi (a b c) public)
(sys/declare superfunction print-stack () public)
(sys/declare superfunction round (a) public)
(sys/declare superfunction cartesian2polar (a b) public)
(sys/declare superfunction polar2cartesian (a b) public)
