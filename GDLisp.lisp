...
(sys/declare superglobal (BUTTON_LEFT BUTTON_LEFT))
(sys/declare superglobal (BUTTON_RIGHT BUTTON_RIGHT))
(sys/declare superglobal (BUTTON_MIDDLE BUTTON_MIDDLE))
(sys/declare superglobal (BUTTON_XBUTTON1 BUTTON_XBUTTON1))
(sys/declare superglobal (BUTTON_XBUTTON2 BUTTON_XBUTTON2))
(sys/declare superglobal (BUTTON_WHEEL_UP BUTTON_WHEEL_UP))
(sys/declare superglobal (BUTTON_WHEEL_DOWN BUTTON_WHEEL_DOWN))
(sys/declare superglobal (BUTTON_WHEEL_LEFT BUTTON_WHEEL_LEFT))
(sys/declare superglobal (BUTTON_WHEEL_RIGHT BUTTON_WHEEL_RIGHT))
(sys/declare superglobal (BUTTON_MASK_LEFT BUTTON_MASK_LEFT))
(sys/declare superglobal (BUTTON_MASK_RIGHT BUTTON_MASK_RIGHT))
(sys/declare superglobal (BUTTON_MASK_MIDDLE BUTTON_MASK_MIDDLE))
(sys/declare superglobal (BUTTON_MASK_XBUTTON1 BUTTON_MASK_XBUTTON1))
(sys/declare superglobal (BUTTON_MASK_XBUTTON2 BUTTON_MASK_XBUTTON2))
(sys/declare superglobal (CORNER_TOP_LEFT CORNER_TOP_LEFT))
(sys/declare superglobal (CORNER_TOP_RIGHT CORNER_TOP_RIGHT))
(sys/declare superglobal (CORNER_BOTTOM_RIGHT CORNER_BOTTOM_RIGHT))
(sys/declare superglobal (CORNER_BOTTOM_LEFT CORNER_BOTTOM_LEFT))
(sys/declare superglobal (JOY_BUTTON_0 JOY_BUTTON_0))
(sys/declare superglobal (JOY_BUTTON_1 JOY_BUTTON_1))
(sys/declare superglobal (JOY_BUTTON_2 JOY_BUTTON_2))
(sys/declare superglobal (JOY_BUTTON_3 JOY_BUTTON_3))
(sys/declare superglobal (JOY_BUTTON_4 JOY_BUTTON_4))
(sys/declare superglobal (JOY_BUTTON_5 JOY_BUTTON_5))
(sys/declare superglobal (JOY_BUTTON_6 JOY_BUTTON_6))
(sys/declare superglobal (JOY_BUTTON_7 JOY_BUTTON_7))
(sys/declare superglobal (JOY_BUTTON_8 JOY_BUTTON_8))
(sys/declare superglobal (JOY_BUTTON_9 JOY_BUTTON_9))
(sys/declare superglobal (JOY_BUTTON_10 JOY_BUTTON_10))
(sys/declare superglobal (JOY_BUTTON_11 JOY_BUTTON_11))
(sys/declare superglobal (JOY_BUTTON_12 JOY_BUTTON_12))
(sys/declare superglobal (JOY_BUTTON_13 JOY_BUTTON_13))
(sys/declare superglobal (JOY_BUTTON_14 JOY_BUTTON_14))
(sys/declare superglobal (JOY_BUTTON_15 JOY_BUTTON_15))
(sys/declare superglobal (JOY_BUTTON_MAX JOY_BUTTON_MAX))
(sys/declare superglobal (JOY_SONY_CIRCLE JOY_SONY_CIRCLE))
(sys/declare superglobal (JOY_SONY_X JOY_SONY_X))
(sys/declare superglobal (JOY_SONY_SQUARE JOY_SONY_SQUARE))
(sys/declare superglobal (JOY_SONY_TRIANGLE JOY_SONY_TRIANGLE))
(sys/declare superglobal (JOY_XBOX_B JOY_XBOX_B))
(sys/declare superglobal (JOY_XBOX_A JOY_XBOX_A))
(sys/declare superglobal (JOY_XBOX_X JOY_XBOX_X))
(sys/declare superglobal (JOY_XBOX_Y JOY_XBOX_Y))
(sys/declare superglobal (JOY_DS_A JOY_DS_A))
(sys/declare superglobal (JOY_DS_B JOY_DS_B))
(sys/declare superglobal (JOY_DS_X JOY_DS_X))
(sys/declare superglobal (JOY_DS_Y JOY_DS_Y))
(sys/declare superglobal (JOY_VR_GRIP JOY_VR_GRIP))
(sys/declare superglobal (JOY_VR_PAD JOY_VR_PAD))
(sys/declare superglobal (JOY_VR_TRIGGER JOY_VR_TRIGGER))
(sys/declare superglobal (JOY_OCULUS_AX JOY_OCULUS_AX))
(sys/declare superglobal (JOY_OCULUS_BY JOY_OCULUS_BY))
(sys/declare superglobal (JOY_OCULUS_MENU JOY_OCULUS_MENU))
(sys/declare superglobal (JOY_OPENVR_MENU JOY_OPENVR_MENU))
(sys/declare superglobal (JOY_SELECT JOY_SELECT))
(sys/declare superglobal (JOY_START JOY_START))
(sys/declare superglobal (JOY_DPAD_UP JOY_DPAD_UP))
(sys/declare superglobal (JOY_DPAD_DOWN JOY_DPAD_DOWN))
(sys/declare superglobal (JOY_DPAD_LEFT JOY_DPAD_LEFT))
(sys/declare superglobal (JOY_DPAD_RIGHT JOY_DPAD_RIGHT))
(sys/declare superglobal (JOY_L JOY_L))
(sys/declare superglobal (JOY_L2 JOY_L2))
(sys/declare superglobal (JOY_L3 JOY_L3))
(sys/declare superglobal (JOY_R JOY_R))
(sys/declare superglobal (JOY_R2 JOY_R2))
(sys/declare superglobal (JOY_R3 JOY_R3))
(sys/declare superglobal (JOY_AXIS_0 JOY_AXIS_0))
(sys/declare superglobal (JOY_AXIS_1 JOY_AXIS_1))
(sys/declare superglobal (JOY_AXIS_2 JOY_AXIS_2))
(sys/declare superglobal (JOY_AXIS_3 JOY_AXIS_3))
(sys/declare superglobal (JOY_AXIS_4 JOY_AXIS_4))
(sys/declare superglobal (JOY_AXIS_5 JOY_AXIS_5))
(sys/declare superglobal (JOY_AXIS_6 JOY_AXIS_6))
(sys/declare superglobal (JOY_AXIS_7 JOY_AXIS_7))
(sys/declare superglobal (JOY_AXIS_8 JOY_AXIS_8))
(sys/declare superglobal (JOY_AXIS_9 JOY_AXIS_9))
(sys/declare superglobal (JOY_AXIS_MAX JOY_AXIS_MAX))
(sys/declare superglobal (JOY_ANALOG_LX JOY_ANALOG_LX))
(sys/declare superglobal (JOY_ANALOG_LY JOY_ANALOG_LY))
(sys/declare superglobal (JOY_ANALOG_RX JOY_ANALOG_RX))
(sys/declare superglobal (JOY_ANALOG_RY JOY_ANALOG_RY))
(sys/declare superglobal (JOY_ANALOG_L2 JOY_ANALOG_L2))
(sys/declare superglobal (JOY_ANALOG_R2 JOY_ANALOG_R2))
(sys/declare superglobal (JOY_VR_ANALOG_TRIGGER JOY_VR_ANALOG_TRIGGER))
(sys/declare superglobal (JOY_VR_ANALOG_GRIP JOY_VR_ANALOG_GRIP))
(sys/declare superglobal (JOY_OPENVR_TOUCHPADX JOY_OPENVR_TOUCHPADX))
(sys/declare superglobal (JOY_OPENVR_TOUCHPADY JOY_OPENVR_TOUCHPADY))
(sys/declare superglobal (MARGIN_LEFT MARGIN_LEFT))
(sys/declare superglobal (MARGIN_TOP MARGIN_TOP))
(sys/declare superglobal (MARGIN_RIGHT MARGIN_RIGHT))
(sys/declare superglobal (MARGIN_BOTTOM MARGIN_BOTTOM))
(sys/declare superglobal (KEY_CODE_MASK KEY_CODE_MASK))
(sys/declare superglobal (KEY_MODIFIER_MASK KEY_MODIFIER_MASK))
(sys/declare superglobal (KEY_MASK_SHIFT KEY_MASK_SHIFT))
(sys/declare superglobal (KEY_MASK_ALT KEY_MASK_ALT))
(sys/declare superglobal (KEY_MASK_META KEY_MASK_META))
(sys/declare superglobal (KEY_MASK_CTRL KEY_MASK_CTRL))
(sys/declare superglobal (KEY_MASK_CMD KEY_MASK_CMD))
(sys/declare superglobal (KEY_MASK_KPAD KEY_MASK_KPAD))
(sys/declare superglobal (KEY_MASK_GROUP_SWITCH KEY_MASK_GROUP_SWITCH))
(sys/declare superglobal (VERTICAL VERTICAL))
(sys/declare superglobal (HORIZONTAL HORIZONTAL))
(sys/declare superglobal (VALIGN_TOP VALIGN_TOP))
(sys/declare superglobal (VALIGN_CENTER VALIGN_CENTER))
(sys/declare superglobal (VALIGN_BOTTOM VALIGN_BOTTOM))
(sys/declare superglobal (KEY_ESCAPE KEY_ESCAPE))
(sys/declare superglobal (KEY_TAB KEY_TAB))
(sys/declare superglobal (KEY_BACKTAB KEY_BACKTAB))
(sys/declare superglobal (KEY_BACKSPACE KEY_BACKSPACE))
(sys/declare superglobal (KEY_ENTER KEY_ENTER))
(sys/declare superglobal (KEY_KP_ENTER KEY_KP_ENTER))
(sys/declare superglobal (KEY_INSERT KEY_INSERT))
(sys/declare superglobal (KEY_DELETE KEY_DELETE))
(sys/declare superglobal (KEY_PAUSE KEY_PAUSE))
(sys/declare superglobal (KEY_PRINT KEY_PRINT))
(sys/declare superglobal (KEY_SYSREQ KEY_SYSREQ))
(sys/declare superglobal (KEY_CLEAR KEY_CLEAR))
(sys/declare superglobal (KEY_HOME KEY_HOME))
(sys/declare superglobal (KEY_END KEY_END))
(sys/declare superglobal (KEY_LEFT KEY_LEFT))
(sys/declare superglobal (KEY_UP KEY_UP))
(sys/declare superglobal (KEY_RIGHT KEY_RIGHT))
(sys/declare superglobal (KEY_DOWN KEY_DOWN))
(sys/declare superglobal (KEY_PAGEUP KEY_PAGEUP))
(sys/declare superglobal (KEY_PAGEDOWN KEY_PAGEDOWN))
(sys/declare superglobal (KEY_SHIFT KEY_SHIFT))
(sys/declare superglobal (KEY_CONTROL KEY_CONTROL))
(sys/declare superglobal (KEY_META KEY_META))
(sys/declare superglobal (KEY_ALT KEY_ALT))
(sys/declare superglobal (KEY_CAPSLOCK KEY_CAPSLOCK))
(sys/declare superglobal (KEY_NUMLOCK KEY_NUMLOCK))
(sys/declare superglobal (KEY_SCROLLLOCK KEY_SCROLLLOCK))
(sys/declare superglobal (KEY_F1 KEY_F1))
(sys/declare superglobal (KEY_F2 KEY_F2))
(sys/declare superglobal (KEY_F3 KEY_F3))
(sys/declare superglobal (KEY_F4 KEY_F4))
(sys/declare superglobal (KEY_F5 KEY_F5))
(sys/declare superglobal (KEY_F6 KEY_F6))
(sys/declare superglobal (KEY_F7 KEY_F7))
(sys/declare superglobal (KEY_F8 KEY_F8))
(sys/declare superglobal (KEY_F9 KEY_F9))
(sys/declare superglobal (KEY_F10 KEY_F10))
(sys/declare superglobal (KEY_F11 KEY_F11))
(sys/declare superglobal (KEY_F12 KEY_F12))
(sys/declare superglobal (KEY_F13 KEY_F13))
(sys/declare superglobal (KEY_F14 KEY_F14))
(sys/declare superglobal (KEY_F15 KEY_F15))
(sys/declare superglobal (KEY_F16 KEY_F16))
(sys/declare superglobal (KEY_KP_MULTIPLY KEY_KP_MULTIPLY))
(sys/declare superglobal (KEY_KP_DIVIDE KEY_KP_DIVIDE))
(sys/declare superglobal (KEY_KP_SUBTRACT KEY_KP_SUBTRACT))
(sys/declare superglobal (KEY_KP_PERIOD KEY_KP_PERIOD))
(sys/declare superglobal (KEY_KP_ADD KEY_KP_ADD))
(sys/declare superglobal (KEY_KP_0 KEY_KP_0))
(sys/declare superglobal (KEY_KP_1 KEY_KP_1))
(sys/declare superglobal (KEY_KP_2 KEY_KP_2))
(sys/declare superglobal (KEY_KP_3 KEY_KP_3))
(sys/declare superglobal (KEY_KP_4 KEY_KP_4))
(sys/declare superglobal (KEY_KP_5 KEY_KP_5))
(sys/declare superglobal (KEY_KP_6 KEY_KP_6))
(sys/declare superglobal (KEY_KP_7 KEY_KP_7))
(sys/declare superglobal (KEY_KP_8 KEY_KP_8))
(sys/declare superglobal (KEY_KP_9 KEY_KP_9))
(sys/declare superglobal (KEY_SUPER_L KEY_SUPER_L))
(sys/declare superglobal (KEY_SUPER_R KEY_SUPER_R))
(sys/declare superglobal (KEY_MENU KEY_MENU))
(sys/declare superglobal (KEY_HYPER_L KEY_HYPER_L))
(sys/declare superglobal (KEY_HYPER_R KEY_HYPER_R))
(sys/declare superglobal (KEY_HELP KEY_HELP))
(sys/declare superglobal (KEY_DIRECTION_L KEY_DIRECTION_L))
(sys/declare superglobal (KEY_DIRECTION_R KEY_DIRECTION_R))
(sys/declare superglobal (KEY_BACK KEY_BACK))
(sys/declare superglobal (KEY_FORWARD KEY_FORWARD))
(sys/declare superglobal (KEY_STOP KEY_STOP))
(sys/declare superglobal (KEY_REFRESH KEY_REFRESH))
(sys/declare superglobal (KEY_VOLUMEDOWN KEY_VOLUMEDOWN))
(sys/declare superglobal (KEY_VOLUMEMUTE KEY_VOLUMEMUTE))
(sys/declare superglobal (KEY_VOLUMEUP KEY_VOLUMEUP))
(sys/declare superglobal (KEY_BASSBOOST KEY_BASSBOOST))
(sys/declare superglobal (KEY_BASSUP KEY_BASSUP))
(sys/declare superglobal (KEY_BASSDOWN KEY_BASSDOWN))
(sys/declare superglobal (KEY_TREBLEUP KEY_TREBLEUP))
(sys/declare superglobal (KEY_TREBLEDOWN KEY_TREBLEDOWN))
(sys/declare superglobal (KEY_MEDIAPLAY KEY_MEDIAPLAY))
(sys/declare superglobal (KEY_MEDIASTOP KEY_MEDIASTOP))
(sys/declare superglobal (KEY_MEDIAPREVIOUS KEY_MEDIAPREVIOUS))
(sys/declare superglobal (KEY_MEDIANEXT KEY_MEDIANEXT))
(sys/declare superglobal (KEY_MEDIARECORD KEY_MEDIARECORD))
(sys/declare superglobal (KEY_HOMEPAGE KEY_HOMEPAGE))
(sys/declare superglobal (KEY_FAVORITES KEY_FAVORITES))
(sys/declare superglobal (KEY_SEARCH KEY_SEARCH))
(sys/declare superglobal (KEY_STANDBY KEY_STANDBY))
(sys/declare superglobal (KEY_OPENURL KEY_OPENURL))
(sys/declare superglobal (KEY_LAUNCHMAIL KEY_LAUNCHMAIL))
(sys/declare superglobal (KEY_LAUNCHMEDIA KEY_LAUNCHMEDIA))
(sys/declare superglobal (KEY_LAUNCH0 KEY_LAUNCH0))
(sys/declare superglobal (KEY_LAUNCH1 KEY_LAUNCH1))
(sys/declare superglobal (KEY_LAUNCH2 KEY_LAUNCH2))
(sys/declare superglobal (KEY_LAUNCH3 KEY_LAUNCH3))
(sys/declare superglobal (KEY_LAUNCH4 KEY_LAUNCH4))
(sys/declare superglobal (KEY_LAUNCH5 KEY_LAUNCH5))
(sys/declare superglobal (KEY_LAUNCH6 KEY_LAUNCH6))
(sys/declare superglobal (KEY_LAUNCH7 KEY_LAUNCH7))
(sys/declare superglobal (KEY_LAUNCH8 KEY_LAUNCH8))
(sys/declare superglobal (KEY_LAUNCH9 KEY_LAUNCH9))
(sys/declare superglobal (KEY_LAUNCHA KEY_LAUNCHA))
(sys/declare superglobal (KEY_LAUNCHB KEY_LAUNCHB))
(sys/declare superglobal (KEY_LAUNCHC KEY_LAUNCHC))
(sys/declare superglobal (KEY_LAUNCHD KEY_LAUNCHD))
(sys/declare superglobal (KEY_LAUNCHE KEY_LAUNCHE))
(sys/declare superglobal (KEY_LAUNCHF KEY_LAUNCHF))
(sys/declare superglobal (KEY_UNKNOWN KEY_UNKNOWN))
(sys/declare superglobal (KEY_SPACE KEY_SPACE))
(sys/declare superglobal (KEY_EXCLAM KEY_EXCLAM))
(sys/declare superglobal (KEY_QUOTEDBL KEY_QUOTEDBL))
(sys/declare superglobal (KEY_NUMBERSIGN KEY_NUMBERSIGN))
(sys/declare superglobal (KEY_DOLLAR KEY_DOLLAR))
(sys/declare superglobal (KEY_PERCENT KEY_PERCENT))
(sys/declare superglobal (KEY_AMPERSAND KEY_AMPERSAND))
(sys/declare superglobal (KEY_APOSTROPHE KEY_APOSTROPHE))
(sys/declare superglobal (KEY_PARENLEFT KEY_PARENLEFT))
(sys/declare superglobal (KEY_PARENRIGHT KEY_PARENRIGHT))
(sys/declare superglobal (KEY_ASTERISK KEY_ASTERISK))
(sys/declare superglobal (KEY_PLUS KEY_PLUS))
(sys/declare superglobal (KEY_COMMA KEY_COMMA))
(sys/declare superglobal (KEY_MINUS KEY_MINUS))
(sys/declare superglobal (KEY_PERIOD KEY_PERIOD))
(sys/declare superglobal (KEY_SLASH KEY_SLASH))
(sys/declare superglobal (KEY_0 KEY_0))
(sys/declare superglobal (KEY_1 KEY_1))
(sys/declare superglobal (KEY_2 KEY_2))
(sys/declare superglobal (KEY_3 KEY_3))
(sys/declare superglobal (KEY_4 KEY_4))
(sys/declare superglobal (KEY_5 KEY_5))
(sys/declare superglobal (KEY_6 KEY_6))
(sys/declare superglobal (KEY_7 KEY_7))
(sys/declare superglobal (KEY_8 KEY_8))
(sys/declare superglobal (KEY_9 KEY_9))
(sys/declare superglobal (KEY_COLON KEY_COLON))
(sys/declare superglobal (KEY_SEMICOLON KEY_SEMICOLON))
(sys/declare superglobal (KEY_LESS KEY_LESS))
(sys/declare superglobal (KEY_EQUAL KEY_EQUAL))
(sys/declare superglobal (KEY_GREATER KEY_GREATER))
(sys/declare superglobal (KEY_QUESTION KEY_QUESTION))
(sys/declare superglobal (KEY_AT KEY_AT))
(sys/declare superglobal (KEY_A KEY_A))
(sys/declare superglobal (KEY_B KEY_B))
(sys/declare superglobal (KEY_C KEY_C))
(sys/declare superglobal (KEY_D KEY_D))
(sys/declare superglobal (KEY_E KEY_E))
(sys/declare superglobal (KEY_F KEY_F))
(sys/declare superglobal (KEY_G KEY_G))
(sys/declare superglobal (KEY_H KEY_H))
(sys/declare superglobal (KEY_I KEY_I))
(sys/declare superglobal (KEY_J KEY_J))
(sys/declare superglobal (KEY_K KEY_K))
(sys/declare superglobal (KEY_L KEY_L))
(sys/declare superglobal (KEY_M KEY_M))
(sys/declare superglobal (KEY_N KEY_N))
(sys/declare superglobal (KEY_O KEY_O))
(sys/declare superglobal (KEY_P KEY_P))
(sys/declare superglobal (KEY_Q KEY_Q))
(sys/declare superglobal (KEY_R KEY_R))
(sys/declare superglobal (KEY_S KEY_S))
(sys/declare superglobal (KEY_T KEY_T))
(sys/declare superglobal (KEY_U KEY_U))
(sys/declare superglobal (KEY_V KEY_V))
(sys/declare superglobal (KEY_W KEY_W))
(sys/declare superglobal (KEY_X KEY_X))
(sys/declare superglobal (KEY_Y KEY_Y))
(sys/declare superglobal (KEY_Z KEY_Z))
(sys/declare superglobal (KEY_BRACKETLEFT KEY_BRACKETLEFT))
(sys/declare superglobal (KEY_BACKSLASH KEY_BACKSLASH))
(sys/declare superglobal (KEY_BRACKETRIGHT KEY_BRACKETRIGHT))
(sys/declare superglobal (KEY_ASCIICIRCUM KEY_ASCIICIRCUM))
(sys/declare superglobal (KEY_UNDERSCORE KEY_UNDERSCORE))
(sys/declare superglobal (KEY_QUOTELEFT KEY_QUOTELEFT))
(sys/declare superglobal (KEY_BRACELEFT KEY_BRACELEFT))
(sys/declare superglobal (KEY_BAR KEY_BAR))
(sys/declare superglobal (KEY_BRACERIGHT KEY_BRACERIGHT))
(sys/declare superglobal (KEY_ASCIITILDE KEY_ASCIITILDE))
(sys/declare superglobal (KEY_NOBREAKSPACE KEY_NOBREAKSPACE))
(sys/declare superglobal (KEY_EXCLAMDOWN KEY_EXCLAMDOWN))
(sys/declare superglobal (KEY_CENT KEY_CENT))
(sys/declare superglobal (KEY_STERLING KEY_STERLING))
(sys/declare superglobal (KEY_CURRENCY KEY_CURRENCY))
(sys/declare superglobal (KEY_YEN KEY_YEN))
(sys/declare superglobal (KEY_BROKENBAR KEY_BROKENBAR))
(sys/declare superglobal (KEY_SECTION KEY_SECTION))
(sys/declare superglobal (KEY_DIAERESIS KEY_DIAERESIS))
(sys/declare superglobal (KEY_COPYRIGHT KEY_COPYRIGHT))
(sys/declare superglobal (KEY_ORDFEMININE KEY_ORDFEMININE))
(sys/declare superglobal (KEY_GUILLEMOTLEFT KEY_GUILLEMOTLEFT))
(sys/declare superglobal (KEY_NOTSIGN KEY_NOTSIGN))
(sys/declare superglobal (KEY_HYPHEN KEY_HYPHEN))
(sys/declare superglobal (KEY_REGISTERED KEY_REGISTERED))
(sys/declare superglobal (KEY_MACRON KEY_MACRON))
(sys/declare superglobal (KEY_DEGREE KEY_DEGREE))
(sys/declare superglobal (KEY_PLUSMINUS KEY_PLUSMINUS))
(sys/declare superglobal (KEY_TWOSUPERIOR KEY_TWOSUPERIOR))
(sys/declare superglobal (KEY_THREESUPERIOR KEY_THREESUPERIOR))
(sys/declare superglobal (KEY_ACUTE KEY_ACUTE))
(sys/declare superglobal (KEY_MU KEY_MU))
(sys/declare superglobal (KEY_PARAGRAPH KEY_PARAGRAPH))
(sys/declare superglobal (KEY_PERIODCENTERED KEY_PERIODCENTERED))
(sys/declare superglobal (KEY_CEDILLA KEY_CEDILLA))
(sys/declare superglobal (KEY_ONESUPERIOR KEY_ONESUPERIOR))
(sys/declare superglobal (KEY_MASCULINE KEY_MASCULINE))
(sys/declare superglobal (KEY_GUILLEMOTRIGHT KEY_GUILLEMOTRIGHT))
(sys/declare superglobal (KEY_ONEQUARTER KEY_ONEQUARTER))
(sys/declare superglobal (KEY_ONEHALF KEY_ONEHALF))
(sys/declare superglobal (KEY_THREEQUARTERS KEY_THREEQUARTERS))
(sys/declare superglobal (KEY_QUESTIONDOWN KEY_QUESTIONDOWN))
(sys/declare superglobal (KEY_AGRAVE KEY_AGRAVE))
(sys/declare superglobal (KEY_AACUTE KEY_AACUTE))
(sys/declare superglobal (KEY_ACIRCUMFLEX KEY_ACIRCUMFLEX))
(sys/declare superglobal (KEY_ATILDE KEY_ATILDE))
(sys/declare superglobal (KEY_ADIAERESIS KEY_ADIAERESIS))
(sys/declare superglobal (KEY_ARING KEY_ARING))
(sys/declare superglobal (KEY_AE KEY_AE))
(sys/declare superglobal (KEY_CCEDILLA KEY_CCEDILLA))
(sys/declare superglobal (KEY_EGRAVE KEY_EGRAVE))
(sys/declare superglobal (KEY_EACUTE KEY_EACUTE))
(sys/declare superglobal (KEY_ECIRCUMFLEX KEY_ECIRCUMFLEX))
(sys/declare superglobal (KEY_EDIAERESIS KEY_EDIAERESIS))
(sys/declare superglobal (KEY_IGRAVE KEY_IGRAVE))
(sys/declare superglobal (KEY_IACUTE KEY_IACUTE))
(sys/declare superglobal (KEY_ICIRCUMFLEX KEY_ICIRCUMFLEX))
(sys/declare superglobal (KEY_IDIAERESIS KEY_IDIAERESIS))
(sys/declare superglobal (KEY_ETH KEY_ETH))
(sys/declare superglobal (KEY_NTILDE KEY_NTILDE))
(sys/declare superglobal (KEY_OGRAVE KEY_OGRAVE))
(sys/declare superglobal (KEY_OACUTE KEY_OACUTE))
(sys/declare superglobal (KEY_OCIRCUMFLEX KEY_OCIRCUMFLEX))
(sys/declare superglobal (KEY_OTILDE KEY_OTILDE))
(sys/declare superglobal (KEY_ODIAERESIS KEY_ODIAERESIS))
(sys/declare superglobal (KEY_MULTIPLY KEY_MULTIPLY))
(sys/declare superglobal (KEY_OOBLIQUE KEY_OOBLIQUE))
(sys/declare superglobal (KEY_UGRAVE KEY_UGRAVE))
(sys/declare superglobal (KEY_UACUTE KEY_UACUTE))
(sys/declare superglobal (KEY_UCIRCUMFLEX KEY_UCIRCUMFLEX))
(sys/declare superglobal (KEY_UDIAERESIS KEY_UDIAERESIS))
(sys/declare superglobal (KEY_YACUTE KEY_YACUTE))
(sys/declare superglobal (KEY_THORN KEY_THORN))
(sys/declare superglobal (KEY_SSHARP KEY_SSHARP))
(sys/declare superglobal (KEY_DIVISION KEY_DIVISION))
(sys/declare superglobal (KEY_YDIAERESIS KEY_YDIAERESIS))
(sys/declare superglobal (HALIGN_LEFT HALIGN_LEFT))
(sys/declare superglobal (HALIGN_CENTER HALIGN_CENTER))
(sys/declare superglobal (HALIGN_RIGHT HALIGN_RIGHT))
(sys/declare superglobal (MIDI_MESSAGE_NOTE_OFF MIDI_MESSAGE_NOTE_OFF))
(sys/declare superglobal (MIDI_MESSAGE_NOTE_ON MIDI_MESSAGE_NOTE_ON))
(sys/declare superglobal (MIDI_MESSAGE_AFTERTOUCH MIDI_MESSAGE_AFTERTOUCH))
(sys/declare superglobal (MIDI_MESSAGE_CONTROL_CHANGE MIDI_MESSAGE_CONTROL_CHANGE))
(sys/declare superglobal (MIDI_MESSAGE_PROGRAM_CHANGE MIDI_MESSAGE_PROGRAM_CHANGE))
(sys/declare superglobal (MIDI_MESSAGE_CHANNEL_PRESSURE MIDI_MESSAGE_CHANNEL_PRESSURE))
(sys/declare superglobal (MIDI_MESSAGE_PITCH_BEND MIDI_MESSAGE_PITCH_BEND))
